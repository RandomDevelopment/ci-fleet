...
| Publish or update from the standalone configuration template | Published v1.0.0 release | Management workstation and a private configuration repository | Yes | Start from the public [v1.0.0 release](https://github.com/RandomDevelopment/ci-fleet-config-template/releases/tag/v1.0.0) at reviewed [template commit `cf4a4d143540e0c70e1f301061038bbf95f04398`](https://github.com/RandomDevelopment/ci-fleet-config-template/commit/cf4a4d143540e0c70e1f301061038bbf95f04398). Its compatibility contract names reviewed ci-fleet core [commit `0aed0d7e85e10050028b7d11fb12b84b3619e638`](https://github.com/RandomDevelopment/ci-fleet/commit/0aed0d7e85e10050028b7d11fb12b84b3619e638). Follow that template commit's [reviewed update procedure](https://github.com/RandomDevelopment/ci-fleet-config-template/blob/cf4a4d143540e0c70e1f301061038bbf95f04398/docs/UPDATING.md#github-template-repositories-have-no-fork-ancestry). Separately review and pin the engine commit for each deployment; v1.0.0 does not claim compatibility with current ci-fleet `main`. This partial correction is tracked by [issue #24](https://github.com/RandomDevelopment/ci-fleet/issues/24). |
