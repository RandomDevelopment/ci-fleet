...
Use GitHub private vulnerability reporting when available. If private reporting is unavailable, contact services@private-repository with the repository name and a concise description.
